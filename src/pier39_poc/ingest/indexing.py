...
Reads the products merge wrote; last ingest stage before search works.
Gotchas: docs/reference/ingest.md
"""
...
from pier39_poc.core.documents import build_document, faq_chunks
from pier39_poc.infra import db
from pier39_poc.infra.artifacts import record_stage, sha256
